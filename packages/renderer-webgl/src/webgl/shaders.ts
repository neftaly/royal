...
const surfaceFragmentShaderSource = (features: SurfaceShaderFeatures, clusteredLights: boolean): string =>
  assertNoShaderTokens(replaceShaderTokens(surfaceFragmentTemplate, new Map([
    ...
    ["__ANISOTROPY_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "anisotropyTexture",
      "texture(u_anisotropyTexture, materialTextureUv(u_anisotropyUvSet, u_anisotropyUvRow0, u_anisotropyUvRow1)).rgb",
      "vec3(1.0, 0.5, 1.0)",
    )],
    ...
    ["__SPECULAR_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "specularTexture",
      "texture(u_specularTexture, materialTextureUv(u_specularUvSet, u_specularUvRow0, u_specularUvRow1)).a",
      "1.0",
    )],
    ["__SPECULAR_COLOR_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "specularColorTexture",
      "texture(u_specularColorTexture, materialTextureUv(u_specularColorUvSet, u_specularColorUvRow0, u_specularColorUvRow1)).rgb",
      "vec3(1.0)",
    )],
    ["__CLEARCOAT_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "clearcoatTexture",
      "texture(u_clearcoatTexture, materialTextureUv(u_clearcoatUvSet, u_clearcoatUvRow0, u_clearcoatUvRow1)).r",
      "1.0",
    )],
    ["__CLEARCOAT_ROUGHNESS_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "clearcoatRoughnessTexture",
      "texture(u_clearcoatRoughnessTexture, materialTextureUv(u_clearcoatRoughnessUvSet, u_clearcoatRoughnessUvRow0, u_clearcoatRoughnessUvRow1)).g",
      "1.0",
    )],
...
return materialTangentNormal(geometricNormal, textureNormal, normalUv);`,
    ...
    ["__DIFFUSE_TRANSMISSION_TEXTURE_EXPR__", surfaceTextureExpression(
      ...
      "texture(u_diffuseTransmissionTexture, materialTextureUv(u_diffuseTransmissionUvSet, u_diffuseTransmissionUvRow0, u_diffuseTransmissionUvRow1)).a",
      "1.0",
    )],
    ["__DIFFUSE_TRANSMISSION_COLOR_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "diffuseTransmissionColorTexture",
      "texture(u_diffuseTransmissionColorTexture, materialTextureUv(u_diffuseTransmissionColorUvSet, u_diffuseTransmissionColorUvRow0, u_diffuseTransmissionColorUvRow1)).rgb",
      "vec3(1.0)",
    )],
    ["__SHEEN_COLOR_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "sheenColorTexture",
      "texture(u_sheenColorTexture, materialTextureUv(u_sheenColorUvSet, u_sheenColorUvRow0, u_sheenColorUvRow1)).rgb",
      "vec3(1.0)",
    )],
    ["__SHEEN_ROUGHNESS_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "sheenRoughnessTexture",
      "texture(u_sheenRoughnessTexture, materialTextureUv(u_sheenRoughnessUvSet, u_sheenRoughnessUvRow0, u_sheenRoughnessUvRow1)).a",
      "1.0",
    )],
    ["__IRIDESCENCE_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "iridescenceTexture",
      "texture(u_iridescenceTexture, materialTextureUv(u_iridescenceUvSet, u_iridescenceUvRow0, u_iridescenceUvRow1)).r",
      "1.0",
    )],
    ["__IRIDESCENCE_THICKNESS_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "iridescenceThicknessTexture",
      "texture(u_iridescenceThicknessTexture, materialTextureUv(u_iridescenceThicknessUvSet, u_iridescenceThicknessUvRow0, u_iridescenceThicknessUvRow1)).g",
      "1.0",
    )],
    ["__MATERIAL_TRANSMISSION_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "materialTransmissionTexture",
      "texture(u_materialTransmissionTexture, materialTextureUv(u_materialTransmissionUvSet, u_materialTransmissionUvRow0, u_materialTransmissionUvRow1)).r",
      "1.0",
    )],
    ...
    ["__EMISSIVE_TEXTURE_EXPR__", surfaceTextureExpression(
      features,
      "emissiveTexture",
      "texture(u_emissiveTexture, materialTextureUv(u_emissiveUvSet, u_emissiveUvRow0, u_emissiveUvRow1)).rgb",
      "vec3(1.0)",
    )],
...
return transmitted * baseColor * materialVolumeAttenuation();`,
    ...
    ["__MATERIAL_TRANSMISSION_SCREEN_CONDITION__", surfaceFeatureBlock(
      features,
      "transmissionScreenTexture",
      "transmission > 0.0",
      "false",
