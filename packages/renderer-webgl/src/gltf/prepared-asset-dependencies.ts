...
import { gltfGeometryDeclaration } from "../geometry-recipes";
...
const materialDependencies = (
  ...
  for (const material of materials) {
    for (const texture of gltfMaterialTextureRefs(material)) {
...
export const planPreparedAssetDependencies = (
  ...
  return {
    ...
    manifest: {
      ...
      ordinaryTextures: materialDependencies(materials),
      virtualTextures: [],
