> Historical design and measurements, archived 2026-09-11. Implemented VT/refinement work shipped in 0.0.24; historical working-tree labels and page sizes below are not current policy.
...
[the completed always-on proposal](always-on-automatic-virtual-texturing.md).
