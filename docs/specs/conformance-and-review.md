...
| Probability native-resolution PBR floor | partial | On physical Safari 17.14/A10 at a 2048-by-1008 backing size, settled Settlers camera motion measures 27--32 ms median / 37--40 ms p95 at about 82 submissions and 44 texture binds per frame; a 52-card SVG import measures roughly 47--49 ms median / 55--60 ms p95 at about 61 submissions. Probability input work remains near 1 ms. Wrong-material collapse, an outside-view depth prepass, global opaque sorting, constant-normal specialization, hoisted GGX work, disabled alpha compositing and disabled MSAA were all insufficient, neutral or regressions and are not retained. The remaining constraint is native fragment/material cost plus a smaller submission component. Royal owns any future exact optimization; resolution reduction, weakened material semantics, device tiers and Probability hints are rejected for the golden path. |
