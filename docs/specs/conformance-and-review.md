...
| Release size gates | gap | The 2026-08-05 audit passes package imports plus packed-consumer structure, TypeScript and runtime-entrypoint checks, then fails the existing ratchets: initial 131,469 > 121,800 gzip bytes, incremental 72,161 > 62,500, glTF initial 132,423 > 122,750, deployed JavaScript 275,163 > 265,450, and Royal-only graph 215,855 > 206,150. Lazy 143,694 <= 143,700 and worker 56,618 <= 56,650 remain within their ceilings. The `0.0.6` renderer package tarball is 622,515 > 577,536 bytes. These are pre-existing gate gaps, not authority to raise ceilings or describe the release check as green. |
