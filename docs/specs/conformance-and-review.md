...
| Hot-path GC discipline | partial | Many retained typed workspaces and high-water capacities exist. Root/frame and focused asset observers share one mutation-safe retained listener owner; publication no longer allocates listener snapshot arrays. Targeted allocations remain in LOD identity, VT admission/demand, binding readiness and public snapshot paths. Trace first and preserve clarity. |
