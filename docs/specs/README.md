...
3. [Scene-to-frame pipeline](scene-to-frame-pipeline.md)
4. [Assets and glTF ingestion](assets-and-gltf.md)
5. [Optional glTF feature profile](optional-gltf-features.md)
6. [Textures and virtual texturing](textures-and-virtual-texturing.md)
7. [Proposed `GS_texture_svg` glTF extension](gs-texture-svg-extension.md)
8. [Rendering and presentation](rendering-and-presentation.md)
9. [Interaction and XR](interaction-and-xr.md)
10. [Resources and performance](resources-and-performance.md)
11. [Hot-path normalization](hot-path-normalization.md)
12. [Failures and diagnostics](failures-and-diagnostics.md)
13. [Conformance and adversarial review](conformance-and-review.md)
