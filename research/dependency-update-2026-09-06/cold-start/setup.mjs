...
const work='/tmp/royal-dependency-cold-start',repo='/home/neftaly/dev/royal';
...
`);
 ...
 for(const name of ['duck.gltf','duck.glb','Duck.bin'])copyFileSync('/tmp/royal-codec-browser/'+name,out+'/'+name);
